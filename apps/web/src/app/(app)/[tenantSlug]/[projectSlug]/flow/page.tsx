...
export default async function Page({
  ...
  return (
    <Card as="section">
      <SectionHead title="Sales Flow" aside={project.name} />
      <StateMessage
        title="Arrives in M3"
        detail="This section will carry the stage ladder, conversion between rungs, time in stage, stalled opportunities and the sell-out forecast. The metrics behind it are already declared in the registry, and the measurement matrix lists every fact each one depends on."
      />
    </Card>
  );
}
