...
export default async function Page({
  ...
  return (
    <Card as="section">
      <SectionHead title="People" aside={project.name} />
      <StateMessage
        title="Arrives in M3"
        detail="This section will carry contacts and their unified timelines, agency and agent performance with sample-size protection, presentation coverage and follow-up delay. The metrics behind it are already declared in the registry, and the measurement matrix lists every fact each one depends on."
      />
    </Card>
  );
}
