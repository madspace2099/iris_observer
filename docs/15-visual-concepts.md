...
The left field opens with the finding in 44px type — *"Northgate sold 7 units this quarter against 9
in the last — 22% slower, and the loss is entirely between viewing and offer"* — then the four
...
**Costs:** the building is a 200px-tall strip. You can see *that* attention is concentrated on the
...
Recorded because `docs/12-visual-autopsy.md` concluded that the previous failure was a *process*
...
verdict sentence in A is excellent and should survive — but it is a *paragraph*, and a paragraph is
