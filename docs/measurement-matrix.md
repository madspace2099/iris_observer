...
| `flow.iris_assisted_sales` | IRIS-assisted sales | ratio | observed sequence | `unit.viewed`, `deal.stage.changed` | `deal.stage`, `deal.unit`, `deal.stage_date` | — | 5 | none | deals | developer, agency_manager |
