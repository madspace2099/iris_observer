...
| 2   | 02 Aug          | Views three two-bedroom units, twice each                                                       | `unit.viewed` ×6                                                       | 3 units, 6 views, 2 unique views per unit                                                                       |
| 3   | 09 Aug          | Second visit; favourites two of the three                                                       | `online.session.observed`, `unit.favourited` ×2                        | favourites survive across sessions                                                                              |
